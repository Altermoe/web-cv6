...
<template>
  <div class="doc-page">
    <h1 class="doc-page__title">ProductionMenu 生产选择菜单</h1>
    <p class="doc-page__desc">城市生产选择菜单，列出可生产的单位、建筑、区域和奇观。</p>
    <div class="doc-todo">
      <span class="doc-todo__badge">TODO</span>
      <p>该组件尚未实现，将在后续迭代中完成。</p>
    </div>
  </div>
</template>
...
.doc-todo {
  ...
  border: 1px dashed var(--civ-gold-700);
